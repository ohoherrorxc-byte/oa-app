<template>
  ...
  <script>
  import subIntoStock from "./subIntoStock";
  import { getOptions, getPartsMaintList } from "@/api/base";
  import { partsNo, partsSubNo,partsSubName, storeId } from "@/util/formSelectList";
  import { saveOrUpdate, stockDelete, submit } from "@/api/substitute/subStockInto";
  export default {
    components: {
      subIntoStock,
    },
    data() {
      return {
        ...
        searchForm: {
          downloadBtn:{
            url:"/api/oa-portal/categoryStockIn/exportStockIn"
          },
          column: [
            {
        ...
        tableColumn: {
          dicUrl: "/api/oa-portal/categoryStockIn/selectPage",
          column: [
            {
              label: "",
              slotName: "payStatus",
