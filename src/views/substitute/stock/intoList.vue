...
export default {
  ...
  data() {
    return {
      ...
      searchForm: {
        downloadBtn:{
          url:"/api/oa-portal/stockIn/exportStockIn"
        },
        column: [
          {
      ...
      tableColumn: {
        dicUrl: "/api/oa-portal/stockIn/selectPage",
        column: [
          {
            label: "",
            slotName: "payStatus",
          ...
          {
            label: this.$t('stock.partsTypeStock'),
            prop: "partsType",
          },
          {
