<template>
  <basic-container>
    ...
    <el-form :disabled="disabled" ref="form" :rules="rules" :model="form" label-width="100px">
      <el-form-item label="采购订单说明" prop="useRemark">
        <el-input type="textarea" v-model="form.useRemark"></el-input>
      </el-form-item>
      <el-form-item label="订单类型" prop="usageInstructions">
        <el-input v-model="value1"></el-input>
      </el-form-item>
      <el-form-item label="相关BOM信息" prop="usageInstructions">
        <el-input v-model="value1"></el-input>
      </el-form-item>
      <el-form-item label="订单编号" prop="usageInstructions">
        <el-input v-model="value1"></el-input>
      </el-form-item>
      <el-form-item label="项目名称" prop="usageInstructions">
        <el-input v-model="value1"></el-input>
      </el-form-item>
      <el-form-item label="供应商信息" prop="usageInstructions">
        <el-input v-model="value1"></el-input>
      </el-form-item>
      <el-form-item label="累计订单数据" prop="usageInstructions">
        <el-input v-model="value1"></el-input>
      </el-form-item>
      <el-form-item label="累计订单金额" prop="usageInstructions">
        <el-input v-model="value1"></el-input>
      </el-form-item>
      <el-form-item label="本批次订单数量" prop="usageInstructions">
        <el-input v-model="value1"></el-input>
      </el-form-item>
      <el-form-item label="本批次订单金额" prop="usageInstructions">
        <el-input v-model="value1"></el-input>
      </el-form-item>
      <div>零件信息</div>
      <el-form-item label-width="0" style="width: 100%;">
        ...
        >
          ...
          <el-table-column property="assetName" label="零件订单数据" align="center">
            <template slot-scope="scope">
              <el-form-item
                style="width: 100%;"
          ...
          <el-table-column property="assetNumber" label="印度需求量" align="center">
            <template slot-scope="scope">
          ...
          <el-table-column label="计划出口日期" align="center">
            <template slot-scope="scope">
              <el-form-item
                style="width: 100%;"
          ...
          <el-table-column property="specificationAndModel" label="单价" align="center">
            <template slot-scope="scope">
              <el-form-item style="width: 100%;">
          ...
          <el-table-column property="brand" label="总金额" align="center">
            <template slot-scope="scope">
              <el-form-item style="width: 100%;">
          ...
          <el-table-column property="brand" label="备注" align="center">
            <template slot-scope="scope">
              <el-form-item style="width: 100%;">
                <el-input clearable v-model="scope.row.brand"></el-input>
              </el-form-item>
      ...
      <el-form-item label-width="0" style="width: 100%;">
        ...
        >
          <el-table-column prop="chooseStatus" type="index" width="50" label="序号"></el-table-column>
          <el-table-column property="assetCategories" label="发货地址" align="center">
            <template slot-scope="scope">
              <el-form-item
                style="width: 100%;"
                :prop="'propertyList.' + scope.$index + '.assetCategories'"
