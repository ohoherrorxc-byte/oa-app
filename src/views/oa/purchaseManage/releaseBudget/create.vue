            ...
            <el-form ref="form" v-model="form" :rules="rules">
                <el-form-item label-width="0" style="width: 100%;">
                    ...
                    <el-table ref="multipleTable" :data="form.partBasicDtoList" @selection-change="handleSelectionChange"
                        ...
                        <el-table-column property="partsCategory" label="节省信息" align="center">
                        ...
                        <el-table-column property="partName" label="成本中心" align="center">
                            <template slot-scope="scope">
                        ...
                        <el-table-column label="采购申请单" align="center">
                            <template slot-scope="scope">
                                <el-form-item style="width: 100%;"
                        ...
                        <el-table-column property="partId" label="合同单号" align="center">
                            <template slot-scope="scope">
                                <el-form-item style="width: 100%;">
                        ...
                        <el-table-column lable="采购价格" prop=""></el-table-column>
                        <el-table-column lable="释放金额" prop=""></el-table-column>
