...
import { managerList, changeState, deleteDeployment } from "@/api/flowManage/flowManage";
...
export default {
      ...
      option: {
        ...
        column: [
          ...
          },
          {
            ...
            type: "select",
            row: true,
            dicUrl: "/api/oa-system/dict/dictionary?code=flow",
            props: {
              label: "dictValue",
              value: "dictKey",
            },
  ...
  methods: {
    ...
    handleImage(row) {
      this.flowUrl = `/api/oa-flow/process/resource-view?processDefinitionId=${row.id}`;
      this.flowBox = true;
    },
