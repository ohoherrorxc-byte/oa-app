  ...
  <basic-container>
    <avue-crud
      ...
      <template slot="menuLeft">
        <div class="btn">
          <upload @handleRequest="handleRequest" :showTip="false" class="mx10" url="/api/oa-portal/flowTable/importPettyCostPay"></upload>
...
export default {
  ...
  methods: {
    async onLoad(page, params = {}) {
      ...
      this.loading = true;
      await PettyPayApi.list(postdata).then((res) => {
    ...
    // 构建与 onLoad 一致的请求参数
      ...
      let res = await PettyPayApi.pettyExport(postdata);
      downBlobFile(res.data, "零星费用申请表单");
    },
    searchReset() {
      this.query = {};
      this.onLoad(this.page);
