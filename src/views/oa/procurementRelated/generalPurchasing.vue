<template>
    ...
    <div style="color: red; font-weight: bold; margin-bottom: 10px;">
         此列表数据由“一般通用采购申请”一键生成“验收申请”，以草稿形式存在“我的流程”，提交前请核对数据正确性。
       </div>
      <TableForm
        ref="TableForm"
  ...
  export default {
    data() {
      return {
        ...
        tableColumn: {
          dicUrl: "/api/oa-portal/purchaseApply/selectPageWithStatus",
          column: [
            {
    ...
    methods: {
      ...
      async clickAccept(row){
        let res = await procurementRelatedApi.saveByPurchaseApply({id:row.id})
