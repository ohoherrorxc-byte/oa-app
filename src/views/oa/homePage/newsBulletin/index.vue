<template>
    <el-row >
        <el-col :span="12" v-for="(item, index) in list" :key="index" class="pr10"> 
            <div class="work-center mtr25">
                <div class="home" @click="navigateToList(item.label)">
                    Home
                </div>
                <el-tabs v-model="activeName" class="pb20 px20">
                    <el-tab-pane :label="item.label" name="first" style="height:200px">
