...
import { saveOrUpdate, stockDelete, submit } from "@/api/supplyChain/stockInto";
export default {
  components: {
    IntoStock,
  },
  data() {
    return {
      ...
      searchForm: {
        downloadBtn:{
          url:"/api/oa-portal/financeStockIn/exportStockIn"
        },
        column: [
          {
      ...
      tableColumn: {
        dicUrl: "/api/oa-portal/financeStockIn/selectPage",
        column: [
          {
            label: "",
            slotName: "payStatus",
