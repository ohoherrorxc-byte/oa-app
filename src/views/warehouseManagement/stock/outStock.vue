  ...
  >
    ...
    >
      <el-row type="flex" justify="space-between">
        ...
        <el-col :span="11">
          <el-form-item label="国家" prop="countryRegionCode">
            <el-select
              v-model="ruleForm.countryRegionCode"
              clearable
              placeholder="请选择"
            >
              <el-option
      ...
      <el-row type="flex" justify="space-between">
        ...
        <el-col :span="11" v-if="ruleForm.useTo === '9'">
      ...
      <div v-for="item in ruleForm.partsStockVOList" :key="item" class="mb10">
        ...
        <el-table
          :data="item.stockVOList"
          style="width: 100%"
          class="mt10 out-stock"
        >
          ...
          <el-table-column prop="stockNumber" label="出库数量">
            <template slot-scope="{ row, $index }">
              <el-form-item label-width="0">
                <el-input
                  v-model.number="row.stockOutNumber"
                  placeholder="请输入出库数量"
                ></el-input>
              </el-form-item>
            </template>
...
<script>
import { selectPage, save } from "@/api/supplyChain/stock";
