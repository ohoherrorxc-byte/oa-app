...
<template>
      <el-dialog title="提示" :visible.sync="dialogVisible" width="30%" style="overflow: hidden; position:fixed;left:0;top:0;;" :before-close="handleClose" :append-to-body="true">
            <div class="content">
