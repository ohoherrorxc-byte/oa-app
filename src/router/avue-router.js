    ...
    formatRoutes: function (aMenu = [], first) {
      ...
      for (let i = 0; i < aMenu.length; i++) {
        ...
        meta = Object.assign(meta, (function () {
          if (option.keepAlive === true&&meta.keepAlive===undefined) {
            return {
              keepAlive: true
            },{
              alias:oMenu.alias
        ...
        const oRouter = {
          ...
          component() {
            // 判断是否为首路由
            if (first) {
              return import(/* webpackChunkName: "p-index" */ '../page/index')
              // 判断是否为多层路由
            } else if (isChild && !first) {
              return import(/* webpackChunkName: "p-layout" */ '../page/index/layout')
              // 判断是否为最终的页面视图
            } else {
              return import(/* webpackChunkName: "v-[request]" */ `../${component}.vue`)
            }
          },
          name: name,
          icon: icon,
